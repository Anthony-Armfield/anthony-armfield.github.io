...
<?php if ( $udesign_options['logo_retina'] == 'yes' ) : ?>
    #logo h1 a, #logo .site-name a { background-image: url('<?php echo $logo_img_url; ?>'); background-size: <?php echo $udesign_options['logo_width']; ?>px <?php echo $udesign_options['logo_height']; ?>px; background-repeat: no-repeat; display: block; width: <?php echo $udesign_options['logo_width']; ?>px; height: <?php echo $udesign_options['logo_height']; ?>px; }
<?php else : ?>
...
<?php endif; ?>
#logo { top: <?php echo $udesign_options['logo_position_vertical']; ?>px; }
...
<?php   endif; ?>
        ...
        #top-wrapper, #c1-header, #c2-header, #c3-header, #rev-slider-header, #page-content-title, #home-page-content, #page-content, .no_title_section #page-content, #before-content, #bottom-bg, #footer-bg { <?php echo $one_continuous_bg_img_with_other_bg_imgs; ?> }
<?php   if ( $udesign_options['enable_responsive'] ) : ?>
    }
<?php   endif; ?>
<?php endif; ?>
...
<?php   if ( $udesign_options['responsive_remove_slider_area'] == 'yes' ) echo '#c1-header, #c2-header, #c3-header, #rev-slider-header { display:none; }'; ?>
...
<?php   if ( $udesign_options['logo_retina'] == 'yes' ) : ?>
            ...
            .mean-container #logo h1 a, .mean-container #logo .site-name a {
                width: <?php echo $udesign_options['logo_width']; ?>px;
                max-width: <?php echo $udesign_options['logo_width']; ?>px;
                background-position: 50% 60%;
                background-size: <?php echo $udesign_options['logo_width']; ?>px <?php echo $udesign_options['logo_height']; ?>px;
                margin: auto;
            }
<?php   endif; ?>
...
$min_screen_width_to_start_fixed_menu = ( $udesign_options['enable_responsive'] && $udesign_options['responsive_menu'] == 'responsive_menu_2' && isset( $udesign_options['menu_2_screen_width'] ) && $udesign_options['menu_2_screen_width'] == 'yes') ? "960" : "720"; ?>

<?php if ($min_screen_width_to_start_fixed_menu == '960') : ?>
@media screen and (min-width: 720px) and (max-width: 959px) {
    #sticky-menu-alias, #sticky-menu-logo { display: none !important; } <?php // the "!important" attribute is required in this case ?>
}
<?php endif; ?>
@media screen and (min-width: <?php echo $min_screen_width_to_start_fixed_menu; ?>px) {
    ...
    .u-design-fixed-menu-on.fixed-menu #top-wrapper {
        background-color:#<?php echo $udesign_options['top_bg_color']; ?>;
        position: fixed;
        display: block;
        width: 100%;
        z-index: 9500;
