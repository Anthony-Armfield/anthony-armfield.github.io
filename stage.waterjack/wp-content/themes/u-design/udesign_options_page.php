...
include( trailingslashit( get_template_directory() ) . 'scripts/admin/google-fonts/udesign-google-web-fonts.php' );
...
<?php	}
	...
	function general_options_contentbox( $options ) { ?>
		...
		<table class="form-table">
			...
			<tr valign="top">
			    <th scope="row"><?php esc_html_e('Retina Logo', 'udesign'); ?></th>
			    <td>
			...
			<tr valign="top">
				...
				<label for="logo_position_center">
				    ...
				    <?php esc_html_e('Center the logo across the header area of the page. ', 'udesign'); ?>
				</label>
                                ...
                                <strong style="margin: 10px 0 5px; display: inline-block;"><?php esc_html_e('Vertical:', 'udesign'); ?></strong><br />
                                <fieldset>
	...
	function layout_options_contentbox( $options ) { ?>
		...
		<table class="form-table">
		  ...
		  <table class="form-table">
			...
			<tr valign="top">
			    <th scope="row" style="padding-right:0"><?php esc_html_e('Global Content Width', 'udesign'); ?></th>
			    <td>
                                <div id="udesign_content_width_slide_bar"></div>
				<input name="udesign_options[udesign_content_width]" type="text" id="udesign_content_width" value="<?php echo ( $options['udesign_content_width'] ) ? esc_attr($options['udesign_content_width']) : '600'; ?>" size="5" maxlength="4" />px. 
                                <span class="description"><?php esc_html_e('(WordPress Content Width) in pixels.', 'udesign'); ?></span>
                                <?php esc_html_e('Content Width is a feature that allows you to set the maximum allowed width for videos, images, and other oEmbed content in a theme. That means, when you paste that YouTube URL in the visual editor and WordPress automatically displays the actual video on the front-end, that video will not exceed the width you set here. ', 'udesign'); ?>
                                <span class="description"><?php esc_html_e('(default: 600)', 'udesign'); ?></span>
                            </td>
                        </tr>
		    </tbody>
                  </table>
