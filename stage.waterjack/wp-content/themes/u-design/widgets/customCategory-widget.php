...
class Custom_Category_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'custom-category-widget', esc_html__('U-Design: Custom Category', 'udesign'), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$category_id = $instance['category_id'];
                if ( function_exists('icl_get_default_language') ) udesign_wpml_replace_category_id( $category_id );
		...
		if ( $category_id ) :
		    if ( $show_as_dropdown ) : ?>
			<ul>
<?php                       $show_option_none = __('Select Category', 'udesign');
