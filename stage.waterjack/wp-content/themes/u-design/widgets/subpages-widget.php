...
class Subpages_Widget extends WP_Widget {
	...
	public function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_subpages', 'description' => esc_html__('Display subpages of the present page.', 'udesign') );
	...
	public function widget( $args, $instance ) {
		...
		if ( $children ) :
		    ...
		    if ( $title ) :
			    ...
			    <h3><?php $parent = get_post($post->post_parent); esc_html_e( $parent->post_title ); ?></h3>
<?php		    endif; ?>
		    <ul>
<?php			echo $children; ?>
		    </ul>
