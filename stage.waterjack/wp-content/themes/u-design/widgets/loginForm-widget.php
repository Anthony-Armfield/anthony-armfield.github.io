...
class Login_Form_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'loginform-widget', esc_html__('U-Design: Login Form', 'udesign'), $widget_ops, $control_ops );
	}
...
<?php			if ( get_option('users_can_register') ) : ?>
			    <li><a href="<?php echo home_url(); ?>/wp-login.php?action=register"><?php esc_attr_e('Register', 'udesign'); ?></a></li>
<?php			endif; ?>
			<li><a href="<?php echo home_url() ?>/wp-login.php?action=lostpassword"><?php esc_attr_e('Recover password', 'udesign'); ?></a></li>
		    </ul>
<?php		endif;
