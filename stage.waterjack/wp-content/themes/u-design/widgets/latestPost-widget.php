...
class Latest_Posts_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		/* Create the widget. */
		parent::__construct( 'latest-posts-widget', esc_html__('U-Design: Recent Posts', 'udesign'), $widget_ops, $control_ops );
...
<?php		endif;
	...
	public function form( $instance ) {
		...
		$defaults = array( 'title' => esc_html__('Latest Posts', 'udesign'), 'category_id' => '', 'num_posts' => 3, 'post_offset' => 0, 'num_words_limit' => 13,'show_date_author' => false,'show_more_link' => false, 'more_link_text' => esc_html__('Read more', 'udesign'), 'show_thumbs' => true, 'remove_thumb_frame' => false, 'thumb_frame_shadow' => false, 'default_thumb' => true, 'post_thumb_width' => 60, 'post_thumb_height' => 60 );
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'num_words_limit' ); ?>"><?php esc_html_e('Limit the number of words to show for each post:', 'udesign'); ?></label>
                    ...
                    <div style="border: 1px solid #DDD; background-color: #F8F8F1; padding:7px; margin:10px 0 17px;">
                        ...
                        <p>
                                <label for="<?php echo $this->get_field_id( 'remove_thumb_frame' ); ?>">
                                    ...
                                    <?php esc_html_e('Remove thumbnail frame', 'udesign'); ?>
                                </label>
                        </p>
                        ...
                        <p>
                                <label for="<?php echo $this->get_field_id( 'default_thumb' ); ?>">
                                    ...
                                    <?php esc_html_e('Use default image (when no image found)', 'udesign'); ?>
                                </label>
                        </p>
