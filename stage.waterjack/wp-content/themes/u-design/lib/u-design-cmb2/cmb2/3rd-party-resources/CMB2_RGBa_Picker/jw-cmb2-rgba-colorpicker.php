...
class JW_Fancy_Color {
	...
	public function setup_admin_scripts() {
		...
		wp_enqueue_script( 'jw-cmb2-rgba-picker-js', get_template_directory_uri() . '/lib/u-design-cmb2/cmb2/3rd-party-resources/CMB2_RGBa_Picker/js/jw-cmb2-rgba-picker.min.js', array( 'wp-color-picker' ), self::VERSION, true );
	}
}
