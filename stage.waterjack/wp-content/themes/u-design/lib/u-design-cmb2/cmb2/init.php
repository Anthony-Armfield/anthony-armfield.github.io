...
if ( ! class_exists( 'CMB2_Bootstrap_226', false ) ) {
	...
	class CMB2_Bootstrap_226 {
		...
		/**
		 * Single instance of the CMB2_Bootstrap_226 object
		 *
		 * @var CMB2_Bootstrap_226
		 */
		public static $single_instance = null;

		/**
		 * Creates/returns the single instance CMB2_Bootstrap_226 object
		 *
		 * @since  2.0.0
		 * @return CMB2_Bootstrap_226 Single instance object
		 */
		...
		public function include_cmb() {
			...
			require_once dirname( __FILE__ ) . '/includes/CMB2_Base.php';
			require_once dirname( __FILE__ ) . '/includes/CMB2.php';
