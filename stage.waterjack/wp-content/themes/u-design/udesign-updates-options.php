...
function udesign_updates_options_menu() {
	global $submenu;
	$udesign_updates_admin_page =  add_submenu_page('udesign_options_page', __( 'Theme Update', 'udesign' ), __( 'Theme Update', 'udesign' ), who_can_edit_udesign_theme_options(), 'udesign_updates_options_page', 'updates_options_page_callback');
