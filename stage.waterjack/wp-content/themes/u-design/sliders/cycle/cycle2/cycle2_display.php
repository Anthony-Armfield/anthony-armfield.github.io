...
<?php				endforeach; ?>
			...
			<span id="c2-pauseButton" style="<?php echo $hide_controls; ?>"><a href="" title="<?php esc_attr_e('Pause', 'udesign'); ?>"><?php esc_html_e('Pause', 'udesign'); ?></a></span>
			<span id="c2-resumeButton" style="<?php echo $hide_controls; ?>"><a href="" title="<?php esc_attr_e('Play', 'udesign'); ?>"><?php esc_html_e('Play', 'udesign'); ?></a></span>
