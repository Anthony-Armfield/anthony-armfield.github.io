...
(function( $ ) {
	$(document).ready(function(){
		//hover toggles buttons
			...
			/*$(".esg-addon-activated").hover(function () {
				$this = $(this);
			    $this.data("original",$this.html());
			    $this.removeClass('esg-status-green').addClass('esg-status-orange').html($this.data('alternative'));
			}, function () {
				$this = $(this);
			    $this.removeClass('esg-status-orange').addClass('esg-status-green').html($this.data("original"));
			});

			$(".esg-addon-not-activated").hover(function () {
				$this = $(this);
			    $this.data("original",$this.html());
			    $this.removeClass('esg-status-orange').addClass('esg-status-green').html($this.data('alternative'));
			}, function () {
				$this = $(this);
			    $this.removeClass('esg-status-green').addClass('esg-status-orange').html($this.data("original"));
			});

			$(".esg-addon-not-installed").hover(function () {
				$this = $(this);
			    $this.data("original",$this.html());
			    $this.removeClass('esg-status-red').addClass('esg-status-green').html($this.data('alternative'));
			}, function () {
				$this = $(this);
			    $this.removeClass('esg-status-green').addClass('esg-status-red').html($this.data("original"));
			});*/
		
		//click event to install plugin
			$(".esg-addon-not-installed").click(function(){
				showWaitAMinute({fadeIn:300,text:essgrid_addon.please_wait_a_moment});
				$this = $(this);
				console.log($this.data("plugin"));
				//console.log("install process");
				$.ajax({
				url : essgrid_addon.ajax_url,
				type : 'post',
				data : {
					action : 'install_essgrid_plugin',
					nonce: 	$('#ajax_essgrid_addon_nonce').text(),// The security nonce
					plugin: $this.data("plugin")
				},
				success : function( response ) {
					switch(response){
						case "0":
								showWaitAMinute({fadeOut:300,text:essgrid_addon.please_wait_a_moment});
		...
		//click event to activate plugin
			$(".esg-addon-not-activated").click(function(){
				showWaitAMinute({fadeIn:300,text:essgrid_addon.please_wait_a_moment});
				...
				type : 'post',
				data : {
					action : 'activate_essgrid_plugin',
					nonce: 	$('#ajax_essgrid_addon_nonce').text(),// The security nonce
					plugin: $this.data("plugin")
				},
				success : function( response ) {
		...
		//click event to deactivate plugin
			$(".esg-dash-deactivate-addon").click(function(){
				showWaitAMinute({fadeIn:300,text:essgrid_addon.please_wait_a_moment});
				$this = $(this);
				...
				type : 'post',
				data : {
					action : 'deactivate_essgrid_plugin',
					nonce: 	$('#ajax_essgrid_addon_nonce').text(),// The security nonce
					plugin: $this.data("plugin")
				},
				success : function( response ) {
